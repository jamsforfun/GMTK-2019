...
public static class UnityRotateExtensions
{
    ...
    public static void Rotate_DegreesPerSecondWithPhysics(this Rigidbody rb, Vector3 euleurDir, float turnRate)
    {
        Quaternion deltaRotation = Quaternion.Euler(euleurDir * Time.deltaTime * turnRate);
